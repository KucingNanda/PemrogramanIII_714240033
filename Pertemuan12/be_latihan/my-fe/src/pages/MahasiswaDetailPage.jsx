  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div className="rounded-xl border bg-white p-4 shadow-sm">
          <p className="text-xs uppercase text-slate-500">No HP</p>
          <p className="mt-1 text-sm font-semibold text-slate-800">
            {mahasiswa.no_hp || "-"}
          </p>
        </div>
        <div className="rounded-xl border bg-white p-4 shadow-sm">
          <p className="text-xs uppercase text-slate-500">Hobi</p>
          <p className="mt-1 text-sm font-semibold text-slate-800">
            {Array.isArray(mahasiswa.hobi) && mahasiswa.hobi.length > 0 
              ? mahasiswa.hobi.join(", ") 
              : "-"}
          </p>
        </div>
