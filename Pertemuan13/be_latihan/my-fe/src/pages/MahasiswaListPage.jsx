...
export default function MahasiswaListPage() {
  ...
  const filteredMahasiswa = useMemo(() => {
    ...
    return mahasiswa.filter((mhs) => {
      // 1. Cek filter prodi terlebih dahulu
      if (filterProdi && mhs.prodi !== filterProdi) {
        return false;
      }

      // 2. Jika keyword kosong, langsung lolos filter
      if (!keyword) return true;

      // 3. Pencarian keyword di semua value object
