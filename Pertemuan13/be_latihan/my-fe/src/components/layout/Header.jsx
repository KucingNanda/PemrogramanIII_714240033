...
export default function Header({ pageTitle, onToggleSidebar }) {
  ...
  const handleShowToken = () => {
    ...
    Swal.fire({
      title: "Token JWT",
      text: token || "Tidak ada token",
      icon: "info",
      confirmButtonText: "Tutup",
      customClass: {
        htmlContainer: "break-all text-xs text-left font-mono bg-slate-100 p-2 rounded-md",
      },
    });
  };
      ...
      <div className="flex w-full items-center justify-between px-4 py-4 md:px-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button
            type="button"
            variant="ghost"
            className="px-3 py-1 text-xs border border-blue-200"
